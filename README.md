...
3. Run the following command to add the SDK as a dependency:
   go get github.com/solafs/go-chainstorage-sdk
...
import "github.com/solafs/go-chainstorage-sdk"
...
repository or project page on platforms like [chainstorage-sdk](https://github.com/solafs/go-chainstorage-sdk).
